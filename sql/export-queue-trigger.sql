...
AS
	...
	AND s.name = 'dajet-exchange-export-service'
	AND e.far_service = 'dajet-exchange-export-service';
	...
	BEGIN
		...
		SELECT @notifications_count = COUNT(*) FROM [dajet-exchange-export-queue] WITH(READCOMMITTEDLOCK, READPAST);
